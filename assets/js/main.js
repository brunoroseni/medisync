...
function applyMasks() {
    // Máscara para CPF
    const cpfInputs = document.querySelectorAll('input[placeholder*="000.000.000-00"]');
    ...
    // Máscara para CEP
    const cepInputs = document.querySelectorAll('input[placeholder*="00000-000"]');
...
function showNotification(message, type = 'info') {
    ...
    notification.innerHTML = `
        <div style="
            ...
            top: 20px;
            right: 20px;
            background: ${type === 'success' ? 'var(--verde-agua)' : type === 'error' ? 'var(--rosa-vivo)' : 'var(--azul-medio)'};
            color: white;
            padding: 16px 24px;
            border-radius: 8px;
